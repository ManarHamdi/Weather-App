...
class WeatherResponceModel {
  Widget getWeatherImage(){
    if (forecast?.forecastday?[0].day?.condition?.text == 'Sunny' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Clear' ||
        forecast?.forecastday?[0].day?.condition?.text == 'partly cloudy') {
      return Image.asset('assets/images/clear.png');
    } else if (

    forecast?.forecastday?[0].day?.condition?.text == 'Blizzard' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Patchy snow possible'  ||
        forecast?.forecastday?[0].day?.condition?.text == 'Patchy sleet possible' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Patchy freezing drizzle possible' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Blowing snow') {
      return Image.asset('assets/images/snow.png');
    } else if (forecast?.forecastday?[0].day?.condition?.text == 'Freezing fog' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Fog' ||  forecast?.forecastday?[0].day?.condition?.text == 'Heavy Cloud'
        || forecast?.forecastday?[0].day?.condition?.text == 'Mist' || forecast?.forecastday?[0].day?.condition?.text == 'Fog') {
      return Image.asset('assets/images/cloudy.png');
    } else if (forecast?.forecastday?[0].day?.condition?.text == 'Patchy rain possible' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Heavy Rain' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Moderate rain') {
      return Image.asset('assets/images/rainy.png');
    } else if (forecast?.forecastday?[0].day?.condition?.text == 'Thundery outbreaks possible' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Moderate or heavy snow with thunder' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Patchy light snow with thunder'||
        forecast?.forecastday?[0].day?.condition?.text == 'Moderate or heavy rain with thunder' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Patchy light rain with thunder' ) {
  ...
  MaterialColor getThemeColor() {
    ...
    forecast?.forecastday?[0].day?.condition?.text == 'Blizzard' ||
      ...
      return Colors.blue;
        ...
        forecast?.forecastday?[0].day?.condition?.text == 'Fog' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Heavy Cloud' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Mist' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Fog') {
      return Colors.blueGrey;
    } else if (forecast?.forecastday?[0].day?.condition?.text == 'Patchy rain possible' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Heavy Rain' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Showers	') {
      return Colors.blue;
    } else if (forecast?.forecastday?[0].day?.condition?.text == 'Thundery outbreaks possible' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Moderate or heavy snow with thunder' ||
        forecast?.forecastday?[0].day?.condition?.text == 'Patchy light snow with thunder'||
